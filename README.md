...
Gnosis Safe and Seaport. The
[Default Framework](https://github.com/fullyallocated/Default) is used as the
main architecture for the protocol, and the contracts in scope can be
